<?php
/**
 * BLOCKED - Quick Setup Script
 * 
 * This script has been disabled. Movies can ONLY be added through the Admin panel.
 * Database schema setup should be done via migration scripts.
 * 
...
<body>
    <div class="blocked">
        ...
        <p>
            Quick setup with automatic movie insertion has been <strong>permanently disabled</strong>.<br>
